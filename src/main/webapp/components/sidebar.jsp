...
<html data-theme="light">
	...
	<body>
		...
		<aside class="menu column is-one-quarter ps-sidebar">
            ...
            <ul class="menu-list">
                <li><a href="${pageContext.request.contextPath}/views/pets.jsp" class="${param.activePage == 'caes' ? 'is-active' : ''}">Cães</a></li>
                <li><a href="${pageContext.request.contextPath}/views/clients.jsp" class="${param.activePage == 'clientes' ? 'is-active' : ''}">Clientes</a></li>
                <li><a href="${pageContext.request.contextPath}/views/services.jsp" class="${param.activePage == 'servicos' ? 'is-active' : ''}">Serviços</a></li>
            </ul>
