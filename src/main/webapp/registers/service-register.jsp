	    	...
	    	<form action="${pageContext.request.contextPath}/controllersvlt" method="post">
		        ...
		        <div class="is-flex is-justify-content-right is-align-items-center mb-4">
		            <div class="is-flex is-align-items-center">
		                ...
		                <input type="text" hidden="true" name="action" value="AddServiceAction">
		                <button type="submit" class="button is-success has-text-weight-semibold">Adicionar</button>
		            </div>
		        </div>
		        ...
		        <div class="columns is-multiline ml-5">
		            ...
		            <div class="column is-half">
		                ...
		                <div class="control">
		                    <input class="input ps-big-input" type="text" name="name" placeholder="Tipo de serviço" required>
		                </div>
		            </div>
		            ...
		            <div class="column is-half">
		                ...
		                <div class="control">
		                    <input class="input" type="text" name="price" placeholder="Preço (ex: 35.50)" required>
		                </div>
		            </div>
